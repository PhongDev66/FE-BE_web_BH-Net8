...
namespace Shopping_Tutorial.Controllers
{
    public class CartController : Controller
    {
		...
		public async Task<IActionResult> Decrease(int Id)
		{
			...
			TempData["success"] = "Giảm sản phẩm vào giỏ hàng thành công! ";
		...
		public async Task<IActionResult> Increase(int Id)
		{
			...
			{
				++cartItem.Quantity;
				TempData["success"] = "Tăng sản phẩm vào giỏ hàng thành công! ";
			}
			else
			{
				cartItem.Quantity = product.Quantity;
				TempData["success"] = "Số lượng sản phẩm tối đa để giỏ hàng thành công! ";
			}
			if (cart.Count == 0)
			{
				HttpContext.Session.Remove("Cart");
		...
		public async Task<IActionResult> Remove(int Id)
		{
			...
			TempData["success"] = "Xoá sản phẩm vào giỏ hàng thành công! ";
			return RedirectToAction("Index");
		}
		...
		public async Task<IActionResult> Clear()
		{
			...
			TempData["success"] = "Xoá tất cả sản phẩm vào giỏ hàng thành công! ";
			return RedirectToAction("Index");
		}
		//tính phí shipping
		[HttpPost]
